...
final class CoreDataManager {
    ...
    func loadPreloadedDatabase(withName name: String) {
        ...
        let sqliteDestinationPath_shm = NSPersistentContainer.defaultDirectoryURL().relativePath + "/\(name).sqlite-shm"
        let sqliteDestinationPath_wal = NSPersistentContainer.defaultDirectoryURL().relativePath + "/\(name).sqlite-wal"
        sqliteDestinationURL = URL(fileURLWithPath: sqliteDestinationPath)
        sqliteDestinationURL_shm = URL(fileURLWithPath: sqliteDestinationPath_shm)
        sqliteDestinationURL_wal = URL(fileURLWithPath: sqliteDestinationPath_wal)
